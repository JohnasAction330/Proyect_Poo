...
export declare const shareProjectWithUser: (req: Request, res: Response) => Promise<void>;
export declare const unshareProjectWithUser: (req: Request, res: Response) => Promise<void>;
